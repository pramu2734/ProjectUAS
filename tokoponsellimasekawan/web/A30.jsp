<p style="text-align:justify;">
    <img src="image/foto/A30.jpeg" alt="Samsung Galaxy A30">
    <br>
...
<p style="text-align: left; font-size: 15px;">
    ...
    <br>
    Layar: 6.4 inch.
    Resolusi layar: 720 x 1560 pixels, 19.5:9 ratio (~268 ppi density).
    ...
    Berat: 169 gram.
    Kamera Belakang: triple kamera 25 MP, f/1.7, 27mm (wide), PDAF; 8 MP, f/2.2, 13mm (ultrawide), 1/4.0", 1.12µm; 5 MP, f/2.2, (depth).
    Kamera Depan: 16 MP, f/2.0, 26mm (wide), 1/3.1", 1.0µm.
    Baterai: Non-removable Li-Po 4000 mAh.
    Jack earphone: 3,5mm audio jack.
    Varian warna: Prism Crush Black, Prism Crush White, Prism Crush Green, Prism Crush Violet.
    <br>
    <br>
<p style="text-align: center; font-size: 20px;">
<tr>
